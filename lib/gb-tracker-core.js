...
var SCHEMAS = {
  ...
  autoSearch: {
    validation:   require('../schemas/validation/autoSearch.json'),
    sanitization: require('../schemas/sanitization/autoSearch.json')
  },
  search: {
    validation:   require('../schemas/validation/search.json'),
    sanitization: require('../schemas/sanitization/search.json')
  },
  sessionChange: {
