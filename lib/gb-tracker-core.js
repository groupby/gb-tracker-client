...
var Tracker = function (customerId, area, overridePixelUrl) {
  ...
  self.__private.sendEvent = function (event, sendSegment) {
    ...
    var eventStringSegments = utils.chunkEscapedString(encodeURIComponent(LZString.compressToEncodedURIComponent(eventString)), MAX_QUERY_STRING_LENGTH - SEGMENT_WRAPPER_OVERHEAD);
