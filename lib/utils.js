...
var chunkEscapedString = function (str, len) {
  ...
  while (str.length > 0) {
    ...
    var sliceIndex = (lastEscape > 0 && len - lastEscape < 3) ? lastEscape : len;
...
module.exports = {
  ...
  jsonEscapeString:           function(str) {
    return JSON.stringify({s: str}).slice(6,-2);
  },
  jsonUnescapeString:           function(str) {
